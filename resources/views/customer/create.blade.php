                            ...
                            <div class="grid grid-cols-1 xl:grid-cols-7">
                                <div class="sm:pr-2 col-span-2">
                                    ...
                                    <p class="font-light text-sm opacity-75 tracking-wide text-gray-800">Once the
                                        customer has been added, you will be able to manage their orders and
                                        more.</p>
                                </div>

                                <div class="pt-4 lg:pt-0 lg:pl-4 col-span-1 lg:col-span-5">
                                    <form action="{{ route('customer.store', $business) }}" method="POST">
                                        @csrf
                                        <div class="pt-4 lg:pt-0 lg:pl-4 col-span-1 lg:col-span-2">
                                            <div class="grid grid-cols-1 lg:grid-cols-2">
                                                ...
                                                <div class="flex flex-col lg:mx-2">
                                                    ...
                                                    <input type="text" name="website" id="website" class="input" value="{{ old('website') }}"
                                            ...
                                            <div class="grid grid-cols-1 lg:grid-cols-12">
                                                <div class="flex flex-col lg:mx-2 lg:col-span-6">
                                                    ...
                                                    <input type="text" name="job_title" id="job_title" class="input" value="{{ old('job_title') }}"
                                                        placeholder="Director...">
                                                    <span class="text-xs text-red-600 my-1"></span>
                                                </div>
                                                <div class="flex flex-col lg:mx-2 col-span-3">
                                                    <label for="tel" class="label">Tel</label>
                                                    <input type="text" name="tel" id="tel" class="input" value="{{ old('tel') }}"
                                                        placeholder="Contect Number">
                                                    <span class="text-xs text-red-600 my-1"></span>
                                                </div>
                                                <div class="flex flex-col lg:mx-2 col-span-3">
                                                    <label for="tel_alt" class="label">Alt. Tel</label>
                                                    <input v-model="form.tel_alt" type="text" name="tel_alt" value="{{ old('tel_alt') }}"
                                                ...
                                                <div class="flex flex-col lg:mx-2 col-span-3">
                                                    ...
                                                    <input type="text" name="city" id="city" class="input" value="{{ old('city') }}"
                                                        placeholder="Exeter">
                                                    <span class="text-xs text-red-600 my-1"></span>
                                                </div>
                                                <div class="flex flex-col lg:mx-2 col-span-3">
                                                    <label for="county" class="label">County</label>
                                                    <input type="text" name="county" id="county" class="input" value="{{ old('county') }}"
                                                        placeholder="Devon">
                                                    <span class="text-xs text-red-600 my-1"></span>
                                                </div>
